...
class Recipe(models.Model):
    ...
    image_file = models.FilePathField(verbose_name='Image file', null=False, blank=False, default="")
    preview_file = models.FilePathField(verbose_name='Preview file', null=False, blank=False, default="")
    ...
    real_url = models.TextField(verbose_name="Real url", null=True)
...
class RecipeGroup(models.Model):
    title = models.CharField(max_length=255, null=False, blank=False, unique=True, verbose_name='Title')
